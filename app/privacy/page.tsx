    ...
    <main style={{ minHeight: '100vh', background: 'var(--background)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
        ...
        {[
          ...
          { title: '9. Age requirement', content: 'AskMedily is intended for users aged 18 and over. We do not knowingly collect personal information from anyone under 18. If you are under 18, you are not permitted to use this service. If we become aware that a user is under 18, we will immediately delete their account and data.' },
